...
user in an INI file next to ReNamerPortable.exe called ReNamerPortable.ini.
...
copy AppNamePortable.ini from this directory to ReNamerPortable.ini next to
ReNamerPortable.exe. The options in the INI file are as follows:
