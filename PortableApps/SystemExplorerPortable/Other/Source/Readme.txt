...
user in an INI file next to SystemExplorerPortable.exe called SystemExplorerPortable.ini.
...
copy AppNamePortable.ini from this directory to SystemExplorerPortable.ini next to
SystemExplorerPortable.exe. The options in the INI file are as follows:
