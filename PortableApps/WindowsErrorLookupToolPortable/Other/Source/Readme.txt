...
user in an INI file next to WindowsErrorLookupToolPortable.exe called 
WindowsErrorLookupToolPortable.ini. If you are happy with the default options, 
it is not necessary, though.  There is an example INI included with this 
package to get you started.  To use it, copy AppNamePortable.ini from this 
directory to WindowsErrorLookupToolPortable.ini next to 
WindowsErrorLookupToolPortable.exe. The options in the INI file are as follows:
