...
user in an INI file next to TexterPortable.exe called TexterPortable.ini.
...
copy AppNamePortable.ini from this directory to TexterPortable.ini next to
TexterPortable.exe. The options in the INI file are as follows:
