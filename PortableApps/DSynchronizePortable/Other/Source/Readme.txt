...
user in an INI file next to DSynchronizePortable.exe called
DSynchronizePortable.ini. If you are happy with the default options, it is not
...
DSynchronizePortable.ini next to DSynchronizePortable.exe. The options in the
