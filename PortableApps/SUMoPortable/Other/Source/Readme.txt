DEVELOPER: Replace the three occurrences of SUMoPortable in this file
...
user in an INI file next to SUMoPortable.exe called SUMoPortable.ini.
...
copy AppNamePortable.ini from this directory to SUMoPortable.ini next to
SUMoPortable.exe. The options in the INI file are as follows:
