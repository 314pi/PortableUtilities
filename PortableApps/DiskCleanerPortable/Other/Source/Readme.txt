...
user in an INI file next to DiskCleanerPortable.exe called DiskCleanerPortable.ini.
...
copy AppNamePortable.ini from this directory to DiskCleanerPortable.ini next to
DiskCleanerPortable.exe. The options in the INI file are as follows:
