...
user in an INI file next to SnapTimerPortable.exe called SnapTimerPortable.ini.
...
copy AppNamePortable.ini from this directory to SnapTimerPortable.ini next to
SnapTimerPortable.exe. The options in the INI file are as follows:
