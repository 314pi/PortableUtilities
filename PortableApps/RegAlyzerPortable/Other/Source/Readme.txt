...
user in an INI file next to RegAlyzerPortable.exe called RegAlyzerPortable.ini.
...
copy AppNamePortable.ini from this directory to RegAlyzerPortable.ini next to
RegAlyzerPortable.exe. The options in the INI file are as follows:
