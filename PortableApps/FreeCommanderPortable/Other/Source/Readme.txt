...
user in an INI file next to FreeCommanderPortable.exe called FreeCommanderPortable.ini.
...
copy AppNamePortable.ini from this directory to FreeCommanderPortable.ini next to
FreeCommanderPortable.exe. The options in the INI file are as follows:
