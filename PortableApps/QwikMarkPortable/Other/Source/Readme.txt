...
user in an INI file next to QwikMarkPortable.exe called QwikMarkPortable.ini.
...
copy AppNamePortable.ini from this directory to QwikMarkPortable.ini next to
QwikMarkPortable.exe. The options in the INI file are as follows:
