...
user in an INI file next to RevoUninstallerPortable.exe called
RevoUninstallerPortable.ini. If you are happy with the default options, it is
...
RevoUninstallerPortable.ini next to RevoUninstallerPortable.exe. The options in
