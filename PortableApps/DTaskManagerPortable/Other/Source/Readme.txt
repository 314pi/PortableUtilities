...
user in an INI file next to DTaskManagerPortable.exe called
DTaskManagerPortable.ini. If you are happy with the default options, it is not
...
DTaskManagerPortable.ini next to DTaskManagerPortable.exe. The options in the
