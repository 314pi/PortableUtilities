...
user in an INI file next to SynkronPortable.exe called SynkronPortable.ini.
...
copy AppNamePortable.ini from this directory to SynkronPortable.ini next to
SynkronPortable.exe. The options in the INI file are as follows:
