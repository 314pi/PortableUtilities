...
user in an INI file next to WinPenguinsPortable.exe called WinPenguinsPortable.ini.
...
copy AppNamePortable.ini from this directory to WinPenguinsPortable.ini next to
WinPenguinsPortable.exe. The options in the INI file are as follows:
