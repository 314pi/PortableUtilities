...
user in an INI file next to AntRenamerPortable.exe called AntRenamerPortable.ini.
...
copy AppNamePortable.ini from this directory to AntRenamerPortable.ini next to
AntRenamerPortable.exe. The options in the INI file are as follows:
