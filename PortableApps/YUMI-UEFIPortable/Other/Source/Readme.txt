...
user in an INI file next to YUMI-UEFIPortable.exe called YUMI-UEFIPortable.ini.
...
copy AppNamePortable.ini from this directory to YUMI-UEFIPortable.ini next to
YUMI-UEFIPortable.exe. The options in the INI file are as follows:
