...
user in an INI file next to WinCDEmuPortable.exe called WinCDEmuPortable.ini.
...
copy AppNamePortable.ini from this directory to WinCDEmuPortable.ini next to
WinCDEmuPortable.exe. The options in the INI file are as follows:
