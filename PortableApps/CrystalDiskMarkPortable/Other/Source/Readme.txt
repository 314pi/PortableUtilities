...
user in an INI file next to CrystalDiskMarkPortable.exe called 
CrystalDiskMarkPortable.ini.If you are happy with the default options, it is not 
...
CrystalDiskMarkPortable.ini next to CrystalDiskMarkPortable.exe. The options 
in the INI file are as follows:
