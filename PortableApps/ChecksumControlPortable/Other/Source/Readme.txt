...
user in an INI file next to ChecksumControlPortable.exe called 
ChecksumControlPortable.ini. If you are happy with the default options, it is 
...
ChecksumControlPortable.ini next to ChecksumControlPortable.exe. The options 
