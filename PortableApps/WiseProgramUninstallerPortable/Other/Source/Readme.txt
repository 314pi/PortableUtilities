DEVELOPER: Replace the three occurrences of WiseProgramUninstallerPortable in this file
...
user in an INI file next to WiseProgramUninstallerPortable.exe called WiseProgramUninstallerPortable.ini.
...
copy AppNamePortable.ini from this directory to WiseProgramUninstallerPortable.ini next to
WiseProgramUninstallerPortable.exe. The options in the INI file are as follows:
