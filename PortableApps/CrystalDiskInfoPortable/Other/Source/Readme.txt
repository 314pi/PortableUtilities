...
user in an INI file next to CrystalDiskInfoPortable.exe called 
CrystalDiskInfoPortable.ini. If you are happy with the default options, it is 
...
CrystalDiskInfoPortable.ini next to CrystalDiskInfoPortable.exe. The options 
