...
user in an INI file next to RapidCRCUnicodePortable.exe called RapidCRCUnicodePortable.ini.
...
copy AppNamePortable.ini from this directory to RapidCRCUnicodePortable.ini next to
RapidCRCUnicodePortable.exe. The options in the INI file are as follows:
