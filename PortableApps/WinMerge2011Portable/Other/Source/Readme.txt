...
user in an INI file next to WinMerge2011Portable.exe called WinMerge2011Portable.ini.
...
copy AppNamePortable.ini from this directory to WinMerge2011Portable.ini next to
WinMerge2011Portable.exe. The options in the INI file are as follows:
