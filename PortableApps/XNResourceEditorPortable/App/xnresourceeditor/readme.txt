...
*  New 'Clone Resource' function.  Makes it easier to clone (eg) string tables
   so they can be translated.

*  'Add Image' now inherits the pixel format/palette from the
   previous image, making it easier to create the same icon with different
   sizes.
