...
user in an INI file next to DebugViewPortable.exe called DebugViewPortable.ini.
...
copy AppNamePortable.ini from this directory to DebugViewPortable.ini next to
DebugViewPortable.exe. The options in the INI file are as follows:
