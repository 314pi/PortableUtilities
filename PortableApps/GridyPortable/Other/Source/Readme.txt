...
user in an INI file next to GridyPortable.exe called GridyPortable.ini. If you
are happy with the default options, it is not necessary, though.  There is an
example INI included with this package to get you started.  To use it, copy
AppNamePortable.ini from this directory to GridyPortable.ini next to
GridyPortable.exe. The options in the INI file are as follows:
