DEVELOPER: Replace the three occurrences of FileVoyagerPortable in this file
...
user in an INI file next to FileVoyagerPortable.exe called FileVoyagerPortable.ini.
...
copy AppNamePortable.ini from this directory to FileVoyagerPortable.ini next to
FileVoyagerPortable.exe. The options in the INI file are as follows:
