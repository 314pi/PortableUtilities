...
user in an INI file next to HDHackerPortable.exe called HDHackerPortable.ini.
...
copy AppNamePortable.ini from this directory to HDHackerPortable.ini next to
HDHackerPortable.exe. The options in the INI file are as follows:
