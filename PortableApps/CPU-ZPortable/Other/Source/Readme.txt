...
user in an INI file next to CPU-ZPortable.exe called CPU-ZPortable.ini.
...
copy AppNamePortable.ini from this directory to CPU-ZPortable.ini next to
CPU-ZPortable.exe. The options in the INI file are as follows:
