...
user in an INI file next to WorldClockPortable.exe called WorldClockPortable.ini.
...
copy AppNamePortable.ini from this directory to WorldClockPortable.ini next to
WorldClockPortable.exe. The options in the INI file are as follows:
