...
user in an INI file next to FastCopyPortable.exe called FastCopyPortable.ini.
...
copy AppNamePortable.ini from this directory to FastCopyPortable.ini next to
