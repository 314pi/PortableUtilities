...
user in an INI file next to TCPViewPortable.exe called TCPViewPortable.ini.
...
copy AppNamePortable.ini from this directory to TCPViewPortable.ini next to
TCPViewPortable.exe. The options in the INI file are as follows:
