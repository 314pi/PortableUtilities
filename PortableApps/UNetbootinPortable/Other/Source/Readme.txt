...
user in an INI file next to UNetbootinPortable.exe called UNetbootinPortable.ini.
...
copy AppNamePortable.ini from this directory to UNetbootinPortable.ini next to
UNetbootinPortable.exe. The options in the INI file are as follows:
