...
user in an INI file next to jPortableBrowserSwitch.exe called jPortableBrowserSwitch.ini.
...
copy AppNamePortable.ini from this directory to jPortableBrowserSwitch.ini next to
jPortableBrowserSwitch.exe. The options in the INI file are as follows:
