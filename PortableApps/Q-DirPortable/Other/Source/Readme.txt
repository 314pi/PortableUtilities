...
user in an INI file next to Q-DirPortable.exe called Q-DirPortable.ini.
...
copy AppNamePortable.ini from this directory to Q-DirPortable.ini next to
Q-DirPortable.exe. The options in the INI file are as follows:
