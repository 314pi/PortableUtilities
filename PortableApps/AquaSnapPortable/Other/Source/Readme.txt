The base application's source code (of applicable) is available from the portable app's
...
This installer and its launcher are released under the GPL. The launcher is the
