...
user in an INI file next to ProcessHackerPortable.exe called 
ProcessHackerPortable.ini. If you are happy with the default options, it is 
...
ProcessHackerPortable.ini next to ProcessHackerPortable.exe. The options in 
