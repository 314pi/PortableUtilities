...
user in an INI file next to ListaryPortable.exe called ListaryPortable.ini.
...
copy AppNamePortable.ini from this directory to ListaryPortable.ini next to
ListaryPortable.exe. The options in the INI file are as follows:
