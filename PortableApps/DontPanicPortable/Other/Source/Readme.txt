...
user in an INI file next to DontPanicPortable.exe called DontPanicPortable.ini.  If
...
AppNamePortable.ini from this directory to DontPanicPortable.ini next to
DontPanicPortable.exe. The options in the INI file are as follows::
