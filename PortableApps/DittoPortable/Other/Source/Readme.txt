...
user in an INI file next to DittoPortable.exe called DittoPortable.ini.
...
copy AppNamePortable.ini from this directory to DittoPortable.ini next to
DittoPortable.exe. The options in the INI file are as follows:
