...
user in an INI file next to AutorunsPortable.exe called AutorunsPortable.ini.
...
copy AppNamePortable.ini from this directory to AutorunsPortable.ini next to
AutorunsPortable.exe. The options in the INI file are as follows:
