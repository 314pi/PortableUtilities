...
user in an INI file next to WhatChangedPortable.exe called WhatChangedPortable.ini.
...
copy AppNamePortable.ini from this directory to WhatChangedPortable.ini next to
WhatChangedPortable.exe. The options in the INI file are as follows:
