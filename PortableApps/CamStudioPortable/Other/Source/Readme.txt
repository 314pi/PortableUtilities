...
user in an INI file next to CamStudioPortable.exe called CamStudioPortable.ini.
...
copy AppNamePortable.ini from this directory to CamStudioPortable.ini next to
CamStudioPortable.exe. The options in the INI file are as follows:
