...
user in an INI file next to TinyTaskPortable.exe called TinyTaskPortable.ini.
...
copy AppNamePortable.ini from this directory to TinyTaskPortable.ini next to
TinyTaskPortable.exe. The options in the INI file are as follows:
