...
user in an INI file next to TreeSizeFreePortable.exe called TreeSizeFreePortable.ini.
...
copy AppNamePortable.ini from this directory to TreeSizeFreePortable.ini next to
TreeSizeFreePortable.exe. The options in the INI file are as follows:
