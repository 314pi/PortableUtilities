DEVELOPER: Replace the three occurrences of KCleanerPortable in this file
...
user in an INI file next to KCleanerPortable.exe called KCleanerPortable.ini.
...
copy AppNamePortable.ini from this directory to KCleanerPortable.ini next to
KCleanerPortable.exe. The options in the INI file are as follows:
