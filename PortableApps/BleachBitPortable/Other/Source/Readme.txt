...
user in an INI file next to BleachBitPortable.exe called BleachBitPortable.ini.
...
copy AppNamePortable.ini from this directory to BleachBitPortable.ini next to
BleachBitPortable.exe. The options in the INI file are as follows:
