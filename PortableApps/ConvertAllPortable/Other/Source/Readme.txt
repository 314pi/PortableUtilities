...
user in an INI file next to ConvertAllPortable.exe called ConvertAllPortable.ini.
...
copy AppNamePortable.ini from this directory to ConvertAllPortable.ini next to
ConvertAllPortable.exe. The options in the INI file are as follows:
