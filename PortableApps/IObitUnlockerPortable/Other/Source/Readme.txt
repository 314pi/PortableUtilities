...
user in an INI file next to IObitUnlockerPortable.exe called IObitUnlockerPortable.ini.
...
copy AppNamePortable.ini from this directory to IObitUnlockerPortable.ini next to
IObitUnlockerPortable.exe. The options in the INI file are as follows:
