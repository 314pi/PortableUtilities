...
user in an INI file next to VirtualVolumesViewPortable.exe called VirtualVolumesViewPortable.ini.
...
copy AppNamePortable.ini from this directory to VirtualVolumesViewPortable.ini next to
VirtualVolumesViewPortable.exe. The options in the INI file are as follows:
