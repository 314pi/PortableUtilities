DEVELOPER: Replace the three occurrences of ccPortable in this file
...
user in an INI file next to ccPortable.exe called ccPortable.ini.
...
copy AppNamePortable.ini from this directory to ccPortable.ini next to
ccPortable.exe. The options in the INI file are as follows:
