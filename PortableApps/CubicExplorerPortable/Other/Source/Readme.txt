...
user in an INI file next to CubicExplorerPortable.exe called CubicExplorerPortable.ini.
...
copy AppNamePortable.ini from this directory to CubicExplorerPortable.ini next to
CubicExplorerPortable.exe. The options in the INI file are as follows:
