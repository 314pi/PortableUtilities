...
user in an INI file next to grepWinPortable.exe called grepWinPortable.ini.
...
copy AppNamePortable.ini from this directory to grepWinPortable.ini next to
grepWinPortable.exe. The options in the INI file are as follows:
