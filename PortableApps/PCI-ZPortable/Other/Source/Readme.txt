...
user in an INI file next to PCI-ZPortable.exe called PCI-ZPortable.ini.
...
copy AppNamePortable.ini from this directory to PCI-ZPortable.ini next to
PCI-ZPortable.exe. The options in the INI file are as follows:
