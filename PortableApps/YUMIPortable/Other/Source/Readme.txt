...
user in an INI file next to YUMIPortable.exe called YUMIPortable.ini.
...
copy AppNamePortable.ini from this directory to YUMIPortable.ini next to
YUMIPortable.exe. The options in the INI file are as follows:
