...
user in an INI file next to DynDNSSimplyClientPortable.exe called DynDNSSimplyClientPortable.ini.
...
copy AppNamePortable.ini from this directory to DynDNSSimplyClientPortable.ini next to
DynDNSSimplyClientPortable.exe. The options in the INI file are as follows:
