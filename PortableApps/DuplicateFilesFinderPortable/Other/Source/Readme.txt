...
user in an INI file next to DuplicateFilesFinderPortable.exe called DuplicateFilesFinderPortable.ini.
...
copy AppNamePortable.ini from this directory to DuplicateFilesFinderPortable.ini next to
DuplicateFilesFinderPortable.exe. The options in the INI file are as follows:
