...
user in an INI file next to SSD-ZPortable.exe called SSD-ZPortable.ini.
...
copy AppNamePortable.ini from this directory to SSD-ZPortable.ini next to
SSD-ZPortable.exe. The options in the INI file are as follows:
