...
user in an INI file next to DUMoPortable.exe called DUMoPortable.ini.
...
copy AppNamePortable.ini from this directory to DUMoPortable.ini next to
DUMoPortable.exe. The options in the INI file are as follows:
