...
user in an INI file next to xpyPortable.exe called xpyPortable.ini.
...
copy AppNamePortable.ini from this directory to xpyPortable.ini next to
xpyPortable.exe. The options in the INI file are as follows:
