...
user in an INI file next to GPU-ZPortable.exe called GPU-ZPortable.ini.
...
copy AppNamePortable.ini from this directory to GPU-ZPortable.ini next to
GPU-ZPortable.exe. The options in the INI file are as follows:
