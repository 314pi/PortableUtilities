DEVELOPER: Replace the three occurrences of GeekUninstallerPortable in this file
...
user in an INI file next to GeekUninstallerPortable.exe called GeekUninstallerPortable.ini.
...
copy AppNamePortable.ini from this directory to GeekUninstallerPortable.ini next to
GeekUninstallerPortable.exe. The options in the INI file are as follows:
